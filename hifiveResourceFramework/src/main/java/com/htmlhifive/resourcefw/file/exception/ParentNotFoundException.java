...
/**
 * urlTreeノードに親ノードが存在しないためにリクエストを実行できない場合にスローされる例外.
 *
 * @author kawaguch
 */
public class ParentNotFoundException extends UrlTreeSystemException {

	private static final long serialVersionUID = 5216363350604463104L;
