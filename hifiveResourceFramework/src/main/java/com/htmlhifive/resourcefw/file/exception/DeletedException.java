...
/**
 * ファイルが削除されておりアクセスできない場合にスローされる例外.
 *
 * @author kawaguch
 */
public class DeletedException extends UrlTreeSystemException {

	private static final long serialVersionUID = -8487411794578814619L;
