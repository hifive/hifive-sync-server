...
/**
 * 多重化リクエストの各リクエスト処理が失敗したとき、常に以降のリクエスト処理を中止する、リソース処理継続ロジック実装.
 *
 * @author kishigam
 */
public class AlwaysTerminatingStrategy implements ProcessContinuationStrategy {

	/**
	 * 指定された例外がスローされた場合にリソース処理プロセスを継続するかどうかを判定し、示す{@link ResourceProcessingStatus}オブジェクトを返します. 常に
	 * {@link ResourceProcessingStatus#TERMINATE}を返します.
	 */
	@Override
