...
/**
 * "409 Conflict"に対応したフレームワーク例外.<br/>
 * アイテムの重複による競合を示します.
 *
 * @author kishigam
 */
public class ConflictException extends AbstractResourceException {

	private static final long serialVersionUID = 9003264785070862146L;

	private static final ResourceActionStatus STATUS = ResourceActionStatus.CONFLICT;

	/**
	 * @see AbstractResourceException
	 */
	public ConflictException(RequestMessage requestMessage) {
	 ...
	 * @see AbstractResourceException
	 */
	public ConflictException(String message, RequestMessage requestMessage) {
	 ...
	 * @see AbstractResourceException
	 */
	public ConflictException(Throwable cause, RequestMessage requestMessage) {
	 ...
	 * @see AbstractResourceException
	 */
	public ConflictException(String message, Throwable cause, RequestMessage requestMessage) {
