...
public class ScheduleResource
        extends SeparatedCommonDataSyncResource<String, ScheduleResourceElement> {
     ...
     */
    @Override
    protected Map<String, ScheduleResourceElement> getImpl(
    ...
    protected String postImpl(ScheduleResourceElement newElement) {
        ...
        ScheduleBean newEntity =
                repository.exists(newElement.getScheduleId())
                        ? new ScheduleBean(generateNewId())
