...
public abstract class SeparatedCommonDataSyncResource<I, E> implements SyncResource<E> {
    ...
    public Set<SyncResponse<E>> getModifiedSince(SyncRequestHeader requestHeader) {
        ...
        Map<String, SyncResponseHeader> responseHeaderMap =
        ...
        Map<String, E> elementMap =
                getImpl(responseHeaderMap.keySet(), requestHeader.getQueryMap());

        Set<SyncResponse<E>> responseSet = new HashSet<>();
        for (String targetResourceIdStr : responseHeaderMap.keySet()) {

            responseSet.add(new SyncResponse<>(
                    responseHeaderMap.get(targetResourceIdStr), elementMap.get(targetResourceIdStr)));
        }
    ...
    public SyncResponse<E> post(SyncRequestHeader requestHeader, E newElement) {
        ...
        try {
            ...
            SyncResponseHeader responseHeaderBeforeCreate =
        ...
        SyncResponseHeader responseHeader =
                syncProvider.saveNewCommonData(requestHeader, newTargetResourceIdStr);
     ...
     */
    protected abstract Map<String, E> getImpl(
